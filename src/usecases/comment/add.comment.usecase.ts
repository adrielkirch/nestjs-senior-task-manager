...
/**
 * Use case class responsible for adding a new comment to the system.
...
export class AddCommentUseCase {
  /**
   * Constructs a new instance of the AddCommentUseCase class.
   ...
   * @returns A Promise that resolves to the simplified representation of the created comment.
   */
  async create(comment: Comment): Promise<CommentResponseDto> {
    const commentDb = await this.commentRepo.create(comment);
